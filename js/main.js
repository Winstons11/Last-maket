...
/* harmony import */ var _components_tooltip__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/tooltip */ "./src/js/components/tooltip.js");
...
const rules = [{
  ...
  rules: [{
    ...
    rule: "email",
    value: true,
    errorMessage: "Введите правельный Email!"
  }]
}];
...
const validateForms = (selector, rules, afterSend) => {
  ...
  if (telSelector) {
    const inputMask = new (inputmask__WEBPACK_IMPORTED_MODULE_1___default())('+380 (99) 999-99-99');
